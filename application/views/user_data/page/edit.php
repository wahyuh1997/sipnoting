      ...
      <div class="card">
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              <input type="text" class="form-control" id="nama" name="nama" value="<?= $data['nama']; ?>" autocomplete="off" required autofocus>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              <input type="number" class="form-control" maxlength="" id="no_hp" name="no_hp" value="<?= $data['no_hp']; ?>" autocomplete="off">
            </div>
          </div>
