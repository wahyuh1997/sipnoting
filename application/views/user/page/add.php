      ...
      <div class="card">
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              <input type="email" class="form-control" id="email" name="email" autocomplete="off" autofocus required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              <input type="password" class="form-control" id="password" name="password" autocomplete="off" minlength="6" maxlength="12" required>
            </div>
          </div>
          <div class="form-group row">
